...
{
    //手动滑动时候暂停自动替换
    [_autoScrolTimer invalidate];
    _autoScrolTimer = nil;
    _autoScrolTimer = [NSTimer scheduledTimerWithTimeInterval:2 target:self selector:@selector(autoShowNextImage) userInfo:nil repeats:YES];
